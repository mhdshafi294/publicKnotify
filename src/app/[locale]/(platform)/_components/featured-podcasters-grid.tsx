...
export default async function FeaturedPodcastersGrid({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-1 lg:gap-2 w-full mx-auto">
        {/* First tall card */}
        <PodcasterCard2
        ...
        <PodcasterCard2
          ...
          className="lg:row-span-1 row-span-2 min-h-[100px]"
        ...
        <PodcasterCard2
          ...
          className="lg:row-span-2 lg:col-start-3 lg:row-start-1 row-span-2 row-start-4 min-h-[100px]"
          contentRatio="lg:h-full"
        />
        <PodcasterCard2
        ...
        <PodcasterCard2
          ...
          className="lg:col-start-5 lg:row-start-1 lg:row-span-1 row-span-2 row-start-6 min-h-[100px]"
          contentRatio="lg:aspect-square"
        />
        <PodcasterCard2
        ...
        <PodcasterCard2
          ...
          className="lg:row-span-2 lg:col-start-6 lg:row-start-1 row-span-2 row-start-9 min-h-[100px]"
          contentRatio="lg:h-full"
        />
      </div>
    </div>
